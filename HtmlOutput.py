...
class HtmlOutput:
    ...
    @staticmethod
    def getTableHeader_per_group(studentgroup):
        sb = ["<tr><th style='border: .1em solid black' scope='col' colspan='2'>Room: ", studentgroup.Name, "</th>\n"]
        for weekDay in HtmlOutput.WEEK_DAYS:
            sb.append("<th style='border: .1em solid black; padding: .25em; width: 15%' scope='col' rowspan='2'>")
            sb.append(weekDay)
            sb.append("</th>\n")
        sb.append("</tr>\n")
        sb.append("<tr>\n")
        sb.append("<th style='border: .1em solid black; padding: .25em'>student group id: ")
        sb.append("Yes" if studentgroup.id else "No")
        sb.append("</th>\n")
        sb.append("<th style='border: .1em solid black; padding: .25em'>Number of students: ")
        sb.append(studentgroup.numberOfStudents)
        sb.append("</th>\n")
        sb.append("</tr>\n")
        return "".join(str(v) for v in sb)